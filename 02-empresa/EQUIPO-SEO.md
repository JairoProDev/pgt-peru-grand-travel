# Equipo SEO + marketing (confirmado día 1)

Actualizado: 25 ago 2026, fin de jornada. Fuente: Jairo en oficina.

## Cuarteto SEO (carga repartida)

| Persona | Tiempo | Rol real | Nota de poder |
|---|---|---|---|
...
- Hay un **interino** (solo mañanas). Nombre: **aún no recordado** — preguntar mañana y anotar.
- Apoya por urgencia temporal. Clever + Jairo hablaron de que Jairo podría asumir el rol (revisión ~2 semanas a S/ 5.000).
- **No anunciar** eso frente al interino ni al cuarteto. Clever anuncia.

## Creativos / otros (web About Us — revalidar)

Cesar, Dafne (CM) · Lidia (diseño) · video en NAS · ventas (Elizabeth, Ubaldina, etc.).
